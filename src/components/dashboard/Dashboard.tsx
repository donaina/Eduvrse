...
const sideMenuData = [
  { name: 'Feed', path: '/instructor/feed' },
  { name: 'My Course', path: '/instructor/course' },
  { name: 'Assessments', path: '/instructor/assessment' },
        ...
        <header className="flex justify-between items-center px-4 py-3 bg-white shadow-sm">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex items-center px-3 py-1 border rounded-md">
              <p className="text-gray-800 font-medium">MR.S</p>
