  ...
  return (
    <div className='px-6 bg-gray-50 '>
      ...
      <div className='mb-6 flex justify-between items-center'>
        ...
        <div className='w-[40%] bg-[#F7F6F6] rounded  lg:flex justify-between items-center pl-2 my-3 outline outline-[#F7F6F6] shadow-[-4px_0_6px_rgba(0,0,0,0.2) shadow-[0_-4px_6px_rgba(0,0,0,0.2)] hidden'>
            <input type="text" className='w-[90%] outline-none h-full bg-[#F7F6F6] px-4' placeholder='search' value={searchQuery}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSearchQuery(e.target.value)} />
            <button className='p-2 bg-[#CBE9FF]'><IoIosSearch size={25} /></button>
          </div>
      </div>
