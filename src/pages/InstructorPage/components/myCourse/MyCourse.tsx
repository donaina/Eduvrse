...
const MyCourse = () => {
 const [searchTerm, setSearchTerm] = useState('');
  ...
  const filteredCourse = assessmentData.filter(
    (assessment) =>
                ...
                >
                  <div className='p-6'>
                    ...
                    <div className='  mb-4  flex justify-between'>
                      ...
                      <button className={`text-black bg-[#EDFF24] w-24 py-1 text-xs rounded-full font-semibold ${course.status.toLowerCase() === 'active' ? 'bg-green-500' : 'bg-yellow-300'}`}>
                        {course.status}
                      </button>
                    </div>
                    ...
                    <div className='h-32 ' >
                      ...
                      <h1 className='font-semibold mb-3'>Description</h1>
                      <p className='mb-6 text-xs text-gray-700 line-clamp-3'>
                      {course.description}
                    </p>
                    </div>

                    <div className='grid grid-cols-2 gap-4 my-1 text-sm text-gray-600'>
                      <div>
                        <strong>Student:</strong> {course.questions}
                      </div>
                      <div>
                        <strong>Chapter:</strong> {course.duration}
                      </div>
                      {/* <div>
                        <strong>Attempts:</strong> {course.attempts}
                      </div>
                      <div>
                    ...
                    {/* <p className='text-xs'>{course.status}</p> */}
                  </div>

                  <div className='mt-4 px-6 w-full h-28 flex gap-3 place-items-center bg-[#D1EAFF]'>
                    <Link to='/edit-course' className='w-full'>
                      <button className=' bg-black w-full py-2 rounded text-white'
                      >
                       Edit
                      </button>
                    </Link>
                    ...
                    <button
                        ...
                        className=' bg-black w-full py-2 rounded text-white'
                      >
                       Analytics
                      </button>
                      </Link>
